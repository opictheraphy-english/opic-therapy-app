#!/usr/bin/env python3
"""Merge comparison_core_extension.json into master_patterns.json (idempotent)."""
...
EXT = ROOT / "data" / "patterns" / "comparison_core_extension.json"
...
def main() -> int:
    ...
    print(f"Appended {added} comparison patterns (skipped duplicates). Total rows: {len(master)}")
    return 0
