#!/usr/bin/env python3
"""One-shot: merge routine_core_extension.json into master_patterns.json (idempotent)."""
...
EXT = ROOT / "data" / "patterns" / "routine_core_extension.json"
...
def main() -> int:
    ...
    print(f"Appended {added} routine patterns (skipped duplicates). Total rows: {len(master)}")
    return 0
